    ...
    <header className={styled.nav}>
        ...
        <div className={styled.link}>
          <ul>
            ...
            <li><a href="/auth/sign-in">get started → </a></li>
          </ul>
        </div>
    </header>
  )
